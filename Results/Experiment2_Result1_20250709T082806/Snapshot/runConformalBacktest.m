function results = runConformalBacktest(params)
    ...
    for t = backtest_start_idx : backtest_end_idx
        ...
        if current_loop_idx == 1 || mod(current_loop_idx - 1, retrainFreq) == 0
            ...
            layers_LSTM = [ ...
                sequenceInputLayer(numFeatures), lstmLayer(numHiddenUnits), ...
                layerNormalizationLayer, lstmLayer(numHiddenUnits), 'OutputMode', 'last',...
                layerNormalizationLayer, fullyConnectedLayer(numOutputs)];
